...
<body>
<h1 align="center">FILL BOOKS DETAILS</h1>
<hr>
<div class="form-container">
<section>
<form action="AddBookServ.jsp" method="post">
<div>
...
<input type="submit" value="Add Book" style="background-color: #219ebc; padding-left: 50px; border-radius: 20px">
</div>
</form>
